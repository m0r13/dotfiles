...
rsync -av --progress --exclude "RobotinoVM*.zip" --exclude "Visual_Paradigm*.exe" --exclude "Visual_Paradigm*.dmg" "/media/hpi/lehrveranstaltungen/FG Systemanalyse und Modellierung/Vorlesung - Modellierung II/" ~/hpi/2_ss15/mod2/
